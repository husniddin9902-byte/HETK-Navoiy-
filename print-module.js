...
function xlsxStructuredSheet(rows,merges,lastRow,hasDrawing,breakRows){
    ...
    return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">'+
        ...
        '<cols><col min="1" max="6" width="7.2" customWidth="1"/><col min="7" max="8" width="8" customWidth="1"/><col min="9" max="12" width="9" customWidth="1"/></cols><sheetData>'+rowXml+'</sheetData>'+mergeXml+
        '<printOptions horizontalCentered="1" verticalCentered="0"/><pageMargins left="0.25" right="0.25" top="0.3" bottom="0.3" header="0.1" footer="0.1"/><pageSetup paperSize="9" orientation="portrait" fitToWidth="1" fitToHeight="'+(lastRow===29?'1':'0')+'" horizontalDpi="300" verticalDpi="300"/>'+breaks+(hasDrawing?'<drawing r:id="rId1"/>':'')+'</worksheet>';
}
