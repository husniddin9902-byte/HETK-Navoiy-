...
const TELEGRAM_BOT_TOKEN = "YOUR_BOT_TOKEN_HERE"; // Bot tokeningizni shu yerga yozasiz
const TELEGRAM_CHAT_ID = "YOUR_PRIVATE_CHANNEL_ID_HERE"; // Maxfiy kanal yoki guruh IDsini yozasiz
